...
description: "This package declares a target Azure RAG architecture and an offline-first `rag.query` fixture. The Bicep declares Search, OpenAI, Storage, and Container Apps resources; deployment, ACL isolation, ing"
icon: "🎯"
order: 1
