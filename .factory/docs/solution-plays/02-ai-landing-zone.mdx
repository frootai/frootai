...
description: "This resource-group-scoped reference currently declares an NSG, one VNet, private DNS zones, Key Vault, Log Analytics, and a user-assigned identity. The broader hub-spoke, private endpoint, Firewall, "
icon: "🎯"
order: 2
