...
description: "Temperature zero, a seed, structured JSON, confidence rules, and validation can reduce variation but do not guarantee identical model output. The current evidence covers the offline `deterministic.exe"
icon: "🎯"
order: 3
...
| Play | `03-deterministic-agent` |
| Version | `1.0.0` |
| Knowledge | R3-Deterministic-AI, O2-AI-Agents |
