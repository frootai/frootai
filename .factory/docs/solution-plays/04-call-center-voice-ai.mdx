...
description: "The diagrams describe a target call flow. The current Bicep declares OpenAI, Storage, Key Vault, Application Insights, Log Analytics, and diagnostics; it does not yet provision Communication Services,"
icon: "🎯"
order: 4
