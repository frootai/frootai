---
title: "Play 06: Play 06 — Document Intelligence 📄"
description: "The package declares an offline `document.process` fixture and Azure resources for a target extraction workflow. Live file validation, hostile-document handling, field provenance, confidence review, P"
icon: "🎯"
order: 6
editUrl: "solution-plays/06-document-intelligence/README.md"
tags: ["solution-play", "play-06"]
---
