...
description: "The offline `agents.execute` fixture demonstrates bounded routing output. The broader specialist workflow, typed handoffs, authority, context isolation, checkpoints, recovery, Dapr policy, and distrib"
icon: "🎯"
order: 7
...
| Play | `07-multi-agent-service` |
| Version | `1.0.0` |
| Knowledge | O2-AI-Agents, O1-Semantic-Kernel |
