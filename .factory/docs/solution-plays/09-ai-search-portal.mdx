---
title: "Play 09: Play 09 — AI Search Portal 🔎"
description: "A search experience combining keyword matching with semantic understanding. AI Search handles retrieval with custom scoring profiles, GPT-4o synthesizes results into readable summaries with citations."
icon: "🎯"
order: 9
editUrl: "solution-plays/09-ai-search-portal/README.md"
tags: ["solution-play", "play-09"]
---
...
| Play | `09-ai-search-portal` |
| Version | `1.0.0` |
| Knowledge | R2-RAG-Architecture, F1-GenAI-Foundations |
