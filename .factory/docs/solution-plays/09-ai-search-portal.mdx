...
description: "The diagrams describe a target portal. The current Bicep does not declare AI Search, App Service, Front Door, managed identity, or private endpoints; ACL trimming, ranking quality, ingestion lifecycle"
icon: "🎯"
order: 9
