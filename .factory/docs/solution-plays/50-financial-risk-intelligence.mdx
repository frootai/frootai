---
title: "Play 50: Play 50 — Financial Risk Intelligence"
description: "AI-powered financial risk platform — explainable credit risk scoring (ECOA/GDPR-compliant), three-tier real-time fraud detection (rules→ML→LLM), market sentiment analysis, regulatory reporting (Basel "
icon: "🎯"
order: 50
editUrl: "solution-plays/50-financial-risk-intelligence/README.md"
tags: ["solution-play", "play-50"]
---
...
| Play | `50-financial-risk-intelligence` |
| Version | `1.0.0` |
| Knowledge | R2-RAG-Architecture, O2-Agent-Coding, R3-Deterministic-AI, T2-Responsible-AI, T3-Production-Patterns, F2-LLM-Selection |
