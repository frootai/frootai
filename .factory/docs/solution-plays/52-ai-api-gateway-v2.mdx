---
title: "Play 52: Play 52 — AI API Gateway V2"
description: "Intelligent AI API gateway — multi-provider routing (Azure OpenAI, Anthropic, Google) with priority-based failover, semantic caching via Redis (embedding similarity), circuit breakers, complexity-base"
icon: "🎯"
order: 52
editUrl: "solution-plays/52-ai-api-gateway-v2/README.md"
tags: ["solution-play", "play-52"]
---
...
| Play | `52-ai-api-gateway-v2` |
| Version | `1.0.0` |
| Knowledge | T3-Production-Patterns, F2-LLM-Landscape, R3-Deterministic-AI |
