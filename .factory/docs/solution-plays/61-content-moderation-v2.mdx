---
title: "Play 61: Play 61 — Content Moderation V2"
description: "Advanced multi-modal content moderation — Azure Content Safety for text+image+video, custom category blocklists, per-category severity thresholds, severity-based routing (auto-block/human-review/flag)"
icon: "🎯"
order: 61
editUrl: "solution-plays/61-content-moderation-v2/README.md"
tags: ["solution-play", "play-61"]
---
...
| Play | `61-content-moderation-v2` |
| Version | `1.0.0` |
| Knowledge | T2-Responsible-AI, F1-GenAI-Foundations, O2-Agent-Coding, T3-Production-Patterns, R3-Deterministic-AI |
