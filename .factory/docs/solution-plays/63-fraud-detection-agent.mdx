---
title: "Play 63: Play 63 — Fraud Detection Agent"
description: "Real-time fraud detection — three-layer architecture: rule engine (<1ms, velocity+geo+amount), ML model (<50ms, statistical patterns+SHAP explainability), graph network analysis (fraud rings, mule acc"
icon: "🎯"
order: 63
editUrl: "solution-plays/63-fraud-detection-agent/README.md"
tags: ["solution-play", "play-63"]
---
...
| Play | `63-fraud-detection-agent` |
| Version | `1.0.0` |
| Knowledge | R3-Deterministic-AI, O2-Agent-Coding, T3-Production-Patterns, F1-GenAI-Foundations |
| WAF Pillars | security, reliability, performance-efficiency, cost-optimization, operational-excellence |
| Groundedness | ≥ 85% |
