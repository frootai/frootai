---
title: "Play 65: Play 65 — AI Training Curriculum"
description: "Adaptive AI-powered learning platform — skill gap analysis against role-skill matrices, dependency-ordered learning paths (topological sort), content matched to learning style (visual/reading/hands-on"
icon: "🎯"
order: 65
editUrl: "solution-plays/65-ai-training-curriculum/README.md"
tags: ["solution-play", "play-65"]
---
...
| Play | `65-ai-training-curriculum` |
| Version | `1.0.0` |
| Knowledge | F1-GenAI-Foundations, T2-Responsible-AI, O2-Agent-Coding, R1-Prompt-Patterns |
| WAF Pillars | responsible-ai, reliability, cost-optimization, operational-excellence |
| Groundedness | ≥ 85% |
