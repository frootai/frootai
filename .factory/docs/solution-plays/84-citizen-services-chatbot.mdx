---
title: "Play 84: Play 84 — Citizen Services Chatbot 🏛️"
description: "Build a government citizen services chatbot. Temperature-zero responses ensure factual accuracy, Azure Translator provides 10+ language support, WCAG 2.2 AA accessibility is built-in, complaint routin"
icon: "🎯"
order: 84
editUrl: "solution-plays/84-citizen-services-chatbot/README.md"
tags: ["solution-play", "play-84"]
---
...
| Version | `1.0.0` |
| Knowledge | R2-RAG-Architecture, O2-AI-Agents, T2-Responsible-AI |
