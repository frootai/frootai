---
title: "Play 96: Play 96 — Realtime Voice Agent V2 📞"
description: "Build a real-time voice agent with sub-500ms time-to-first-byte. GPT-4o Realtime API streams responses token-by-token, Azure Speech provides streaming STT/TTS with SSML, barge-in detection lets users "
icon: "🎯"
order: 96
editUrl: "solution-plays/96-realtime-voice-agent-v2/README.md"
tags: ["solution-play", "play-96"]
---
...
| Play | `96-realtime-voice-agent-v2` |
| Version | `1.0.0` |
| Knowledge | O2-AI-Agents, T3-Production-Patterns, O3-MCP-Tools-Functions |
| WAF Pillars | performance-efficiency, reliability, responsible-ai, security |
