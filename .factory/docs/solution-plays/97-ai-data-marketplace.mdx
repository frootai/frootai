---
title: "Play 97: Play 97 — AI Data Marketplace 📊"
description: "Build an AI data marketplace. 5-dimension quality scoring (completeness, consistency, accuracy, timeliness, uniqueness) grades every dataset, PII scanning + k-anonymity + differential privacy enable p"
icon: "🎯"
order: 97
editUrl: "solution-plays/97-ai-data-marketplace/README.md"
tags: ["solution-play", "play-97"]
---
...
| Play | `97-ai-data-marketplace` |
| Version | `1.0.0` |
| Knowledge | T3-Production-Patterns, T2-Responsible-AI, O4-Azure-AI-Foundry |
