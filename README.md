...
- **🛡️ Eval-first** — every skill and play ships with a regression-tested eval harness; the numbers live in the repo (637/637 spec conformance) and drift breaks CI. Capability is *proven*, not promised.
...
Every skill and play is gated by a regression eval harness — **637/637 skills pass spec conformance** today, across **100+ solution plays** and **334 skills**. The table below is auto-generated from the eval reports in [`reports/`](./reports) and is never hand-edited.
...
|---|---|---|
| **Spec conformance** (skills-ref 0.1.5) | **637/637 valid** (100%) | 637 skills |
