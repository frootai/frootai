...
NATS specialist for lightweight, high-performance event-driven AI microservice communication; uses JetStream for durable streams, KV for state, object store for artifacts, and request-reply.
