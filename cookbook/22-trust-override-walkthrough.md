...
A properly documented `trust_overrides` entry that allows your agent or play to attach a community-tier MCP server without failing the M10.6 trust policy validator. You'll follow a structured review process and produce an audit-ready override declaration.
...
Use the checklist above. Document findings in your team's security review system (Jira, Linear, GitHub Issue, etc.).
