...
KV cache, activations, runtime buffers, batching, and framework overhead also consume memory.

</details>

### 2. What metric reveals insufficient serving capacity before outright failure?

<details>
<summary>Expected evidence</summary>

Queue depth and queue delay rising under a stable arrival rate.

</details>

### 3. Why must region and SKU claims be discovered live?

<details>
<summary>Expected evidence</summary>

Capacity, quotas, and available VM families vary by subscription and change over time.
