...
> **API guidance verified:** 2026-08-03 against the [Microsoft Foundry SDK and endpoint guide](https://learn.microsoft.com/azure/foundry/how-to/develop/sdk-overview)
...
**Python (current OpenAI v1 endpoint) — Minimal call:**
...
| Endpoint | Use |
|---|---|
| `https://<resource>.services.ai.azure.com/openai/v1/` | Current Foundry project/resource model inference |
| `https://<resource>.openai.azure.com/openai/v1/` | Existing Azure OpenAI resource using the stable v1 route |
| Monthly `api-version` route | Classic compatibility only; follow the migration guide before new implementation |
...
### Model Limits and Lifecycle

Model limits vary by provider, deployment, region, and model snapshot. Verify them at design time and again before release:

| Provider | Authoritative catalog | Production guidance |
|---|---|---|
| OpenAI | [Models](https://developers.openai.com/api/docs/models) | Pin an intentional model ID and monitor deprecations |
| Microsoft Foundry | [Foundry models](https://learn.microsoft.com/azure/foundry/foundry-models/concepts/models) | Confirm region, deployment type, quota, and lifecycle in the target subscription |
| Anthropic | [Claude models](https://platform.claude.com/docs/en/docs/about-claude/models/overview) | Check model IDs, context, cloud endpoint type, and retirement dates |
| Google | [Gemini models](https://ai.google.dev/gemini-api/docs/models) | Prefer a stable ID for production; preview/latest aliases can change |
| Amazon Bedrock | [Models at a glance](https://docs.aws.amazon.com/bedrock/latest/userguide/model-cards.html) | Confirm provider, region, modality, and inference profile support |

### Context-Window Snapshot (March 2026)

The table below is retained as a dated comparison, not as a deployment contract. Follow the catalogs above for current limits.
...
### Azure OpenAI Pricing Snapshot (March 2026, per 1M Tokens)

*Historical comparison only. Prices reflect Global Standard deployment where it was available in March 2026. Check the [Azure OpenAI pricing page](https://azure.microsoft.com/pricing/details/cognitive-services/openai-service/) and target subscription before any estimate.*
...
### Global Batch Pricing Snapshot (March 2026)
...
## Card 5: Microsoft Foundry Deployment Types
