...
> **Reliability guidance verified:** 2026-08-03 against [Microsoft Foundry evaluation guidance](https://learn.microsoft.com/azure/foundry/concepts/evaluation-evaluators/), [OpenAI reproducibility guidance](https://developers.openai.com/api/docs/guides/evals), and the [NIST AI RMF](https://www.nist.gov/itl/ai-risk-management-framework)
...
- Model A: 2.50 units/1M input tokens, 10.00 units/1M output tokens
- Model B: 0.15 units/1M input tokens, 0.60 units/1M output tokens
- Search Basic: 75 units/month, Search Standard: 250 units/month
...
4. If the user asks about live or historical pricing, say "This fixture is not live pricing" and request a dated authoritative source.
```
