...
> **Retrieval guidance verified:** 2026-08-03 against [Azure AI Search documentation](https://learn.microsoft.com/azure/search/), [Microsoft Foundry evaluation guidance](https://learn.microsoft.com/azure/foundry/concepts/evaluation-evaluators/rag-evaluators), and the [OpenAI embeddings guide](https://developers.openai.com/api/docs/guides/embeddings)
...
These ranges are experiment starting points, not defaults. Measure retrieval hit rate or NDCG and end-to-end answer quality on representative queries, then tune chunk boundaries, overlap, and metadata together.
...
|---|---|---|---|---|---|
| **Free** | 1 | 1 | 8 MB | No | See current pricing |
...
| **S3 HD** | 12 | 3 | 200 GB per partition | Yes | See current pricing |

> Service limits and prices vary by region and can change. Verify the target tier in [Azure AI Search service limits](https://learn.microsoft.com/azure/search/search-limits-quotas-capacity) and [Azure AI Search pricing](https://azure.microsoft.com/pricing/details/search/) before sizing.
