...
A narrow purpose, typed contract, explicit authorization, bounded side effects, and observable failures.

</details>

### 2. Why should read and write tools be separate?

<details>
<summary>Expected evidence</summary>

They carry different risk, consent, idempotency, and approval requirements.

</details>

### 3. When is migration to Agent Framework justified?

<details>
<summary>Expected evidence</summary>

When the application needs capabilities owned by the newer agent lifecycle, not merely because a newer SDK exists.
