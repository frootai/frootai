...
> Copilot for Teams Extension — declarative agents, API plugins, message extensions, and adaptive cards for Microsoft 365 Copilot. Build custom AI experiences inside Teams, Outlook, and M365 apps.

## Overview

Bundles **15 primitives** (4 agents, 3 instructions, 4 skills, 4 hooks) in one installable package; all are WAF-aligned and compatible with the FAI Protocol auto-wiring system.
