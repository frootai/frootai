...
> Fine-Tuning & MLOps: dataset curation, training, hyperparameter optimization, model registry, deployment pipelines. End-to-end ML lifecycle with Azure AI Foundry, MLflow, and evaluation gates.

## Overview

This plugin bundles **14 primitives** (3 agents, 2 instructions, 5 skills, 4 hooks) into one installable package. All primitives are WAF-aligned and compatible with the FAI Protocol auto-wiring system.
