...
> Fine-Tuning Workflow — dataset prep, training-job orchestration, evaluation pipelines, model registry, and deployment automation for GPT, Phi, and open-source models on Azure AI Foundry.

## Overview

This plugin bundles **17 primitives** (5 agents, 3 instructions, 5 skills, 4 hooks) in one installable package. All primitives are WAF-aligned and compatible with the FAI Protocol auto-wiring system.
