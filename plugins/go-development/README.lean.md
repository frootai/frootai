...
This plugin bundles **8 primitives** (2 agents, 2 instructions, 1 skills, 3 hooks) into one installable package. All primitives are WAF-aligned and compatible with the FAI Protocol auto-wiring system.
...
| Type | Name | Purpose |
|------|------|---------|
| Agent | `frootai-go-expert` | Go expert |
| Agent | `frootai-go-mcp-expert` | Go mcp expert |
| Instruction | `go-waf` | Go waf standards |
| Instruction | `grpc-waf` | Grpc waf standards |
| Skill | `frootai-mcp-go-scaffold` | Mcp go scaffold |
