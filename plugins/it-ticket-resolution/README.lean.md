...
> IT Ticket Resolution: automated incident classification, knowledge base search, resolution suggestion, and escalation routing via RAG over IT docs with Azure AI Search and Semantic Kernel orchestration.
...
| Type | Name | Purpose |
|------|------|---------|
| Agent | `frootai-play-05-builder` | Play 05 builder |
| Agent | `frootai-play-05-reviewer` | Play 05 reviewer |
| Agent | `frootai-play-05-tuner` | Play 05 tuner |
| Agent | `frootai-rag-expert` | Rag expert |
| Agent | `frootai-semantic-kernel-expert` | Semantic kernel expert |
