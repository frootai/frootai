...
This plugin bundles **18 primitives** (5 agents, 3 instructions, 5 skills, 5 hooks) into one installable package. All primitives are WAF-aligned and compatible with the FAI Protocol auto-wiring system.
