...
## Overview
Add circuit breaker pattern for Azure OpenAI calls with fallback behavior. This skill provides a production-grade, step-by-step procedure for implementing this capability in FAI solution plays.
