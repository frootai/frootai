...
## Overview
Configure Azure Content Safety API with custom categories and thresholds. This skill provides a production-grade, step-by-step procedure for implementing this capability in FAI solution plays.
