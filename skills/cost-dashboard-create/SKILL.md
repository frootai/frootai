...
## Overview
Create a cost attribution dashboard for AI workloads with Azure Cost Management. This skill provides a production-grade, step-by-step procedure for implementing this capability in FAI solution plays.
