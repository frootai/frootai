...
## Overview
Migrate data and embeddings between vector databases with zero downtime. This skill provides a production-grade, step-by-step procedure for implementing this capability in FAI solution plays.
