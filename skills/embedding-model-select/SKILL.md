...
## Overview
Select and configure the optimal embedding model for vector search. This skill provides a production-grade, step-by-step procedure for implementing this capability in FAI solution plays.
