...
## Overview
Create an evaluation pipeline with Azure AI Evaluation SDK and CI gate logic. This skill provides a production-grade, step-by-step procedure for implementing this capability in FAI solution plays.
