...
# FAI Skill: Containerize Aspnet Framework

## Purpose

This skill defines a production-oriented workflow for Windows container build pipelines for ASP.NET Framework. It is intended for builders and reviewers who need repeatable outcomes, explicit validation, and clear rollback guidance.
...
| Input | Description |
|---|---|
| Core parameters | solution_path, base_image, iis_site_name, ports |
...
| Artifact | Purpose |
|---|---|
| Primary output | Dockerfile.windows, container smoke-test script, deployment notes |
...
- [ ] Completion criteria met: docker build succeeds, app responds on /health, image vulnerability scan under policy.
