...
# FAI Skill: Context Map

## Purpose

This skill defines a production-oriented workflow for Bounded context discovery and ownership boundaries. It is intended for builders and reviewers who need repeatable outcomes, explicit validation, and clear rollback guidance.
...
| Input | Description |
|---|---|
| Core parameters | domain_terms, event_flows, team_topology, integration_constraints |
...
| Artifact | Purpose |
|---|---|
| Primary output | context-map.md, ownership matrix, integration contracts list |
...
- [ ] Completion criteria met: all critical domains mapped, upstream/downstream relationships labeled, anti-corruption layers identified.
