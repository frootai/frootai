---
name: fai-copilot-cli-quickstart
description: 'Bootstraps a productive GitHub Copilot CLI workflow for repository tasks.'
---

# FAI Skill: Copilot Cli Quickstart

## Purpose

This skill defines a production-oriented workflow for CLI-assisted planning, edits, and validation loops. It is intended for builders and reviewers who need repeatable outcomes, explicit validation, and clear rollback guidance.
...
| Input | Description |
|---|---|
| Core parameters | repo_layout, common_tasks, lint_commands, test_commands |
...
| Artifact | Purpose |
|---|---|
| Primary output | quickstart-playbook.md, command snippets, safety guardrails |
...
- [ ] Completion criteria met: new contributor can complete first task quickly, checks documented, rollback path clear.
