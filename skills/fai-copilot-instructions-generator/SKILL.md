...
description: 'Generates high-signal Copilot instruction files tailored to project architecture and standards.'
---

# FAI Skill: Copilot Instructions Generator

## Purpose

This skill defines a production-oriented workflow for Instruction quality, scope, and maintainability. It is intended for builders and reviewers who need repeatable outcomes, explicit validation, and clear rollback guidance.
...
| Input | Description |
|---|---|
| Core parameters | project_conventions, quality_gates, security_rules, testing_expectations |
...
| Artifact | Purpose |
|---|---|
| Primary output | copilot-instructions draft, applyTo guidance, maintenance checklist |
...
- [ ] Completion criteria met: instructions are concise, non-duplicative, and actionable for contributors.
