---
name: fai-copilot-spaces-setup
description: 'Configures Copilot Spaces for reusable team knowledge, prompts, and workflows.'
---

# FAI Skill: Copilot Spaces Setup

## Purpose

This skill defines a production-oriented workflow for Shared context curation and lifecycle. It is intended for builders and reviewers who need repeatable outcomes, explicit validation, and clear rollback guidance.
...
| Input | Description |
|---|---|
| Core parameters | space_taxonomy, source_docs, refresh_cadence, ownership_model |
...
| Artifact | Purpose |
|---|---|
| Primary output | spaces-setup-guide.md, curation rubric, review cadence |
...
- [ ] Completion criteria met: space discoverability improved, stale content detection in place, ownership assigned.
