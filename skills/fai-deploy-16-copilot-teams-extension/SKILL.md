---
name: fai-deploy-16-copilot-teams-extension
description: 'Executes production deployment workflow for Solution Play 16 Copilot Teams Extension.'
---

# FAI Skill: Deploy 16 Copilot Teams Extension

## Purpose

This skill provides a production-oriented workflow for Teams extension readiness, tenant controls, and release governance. It enforces explicit phase evidence, clear release gates, and repeatable handoff quality.

## Inputs

| Input | Description |
|---|---|
| Core parameters | manifest_version, tenant_targets, auth_scopes, rollout_plan |
...
| Artifact | Purpose |
|---|---|
| Primary output | deploy-checklist-16.md, tenant validation log, rollback steps |
...
- [ ] Completion criteria met: tenant install checks pass, permissions validated, staged rollout approved.
