---
name: fai-deploy-17-ai-observability
description: 'Executes production deployment workflow for Solution Play 17 AI Observability.'
---

# FAI Skill: Deploy 17 Ai Observability

## Purpose

This skill provides a production-oriented workflow for Telemetry integrity, KPI baselines, and incident-ready observability. It enforces explicit phase evidence, clear release gates, and repeatable handoff quality.

## Inputs

| Input | Description |
|---|---|
| Core parameters | trace_schema, metric_catalog, alert_rules, retention_policy |
...
| Artifact | Purpose |
|---|---|
| Primary output | deploy-checklist-17.md, observability baseline, alert tuning report |
...
- [ ] Completion criteria met: end-to-end traces complete, KPI dashboards healthy, alert routing verified.
