---
name: fai-deploy-19-edge-ai-phi4
description: 'Executes production deployment workflow for Solution Play 19 Edge AI Phi-4.'
---

# FAI Skill: Deploy 19 Edge Ai Phi4

## Purpose

This skill provides a production-oriented workflow for Edge inference reliability, device constraints, and offline resilience. It enforces explicit phase evidence, clear release gates, and repeatable handoff quality.

## Inputs

| Input | Description |
|---|---|
| Core parameters | model_bundle, device_profile, update_channel, sync_policy |
...
| Artifact | Purpose |
|---|---|
| Primary output | deploy-checklist-19.md, device validation summary, fallback config |
...
- [ ] Completion criteria met: on-device latency within target, offline mode tested, update rollback proven.
