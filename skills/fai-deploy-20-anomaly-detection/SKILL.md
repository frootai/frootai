---
name: fai-deploy-20-anomaly-detection
description: 'Executes production deployment workflow for Solution Play 20 Anomaly Detection.'
---

# FAI Skill: Deploy 20 Anomaly Detection

## Purpose

This skill provides a production-oriented workflow for Detection quality, false-positive controls, and alert lifecycle. It enforces explicit phase evidence, clear release gates, and repeatable handoff quality.

## Inputs

| Input | Description |
|---|---|
| Core parameters | detection_models, baseline_windows, sensitivity_levels, escalation_rules |
...
| Artifact | Purpose |
|---|---|
| Primary output | deploy-checklist-20.md, detection benchmark, threshold matrix |
...
- [ ] Completion criteria met: precision/recall gates satisfied, alert fatigue bounded, escalation SLA validated.
