...
description: Deploy Multi-Agent Swarm coordinator with topology and state sync.
---
...
npx frootai skill run fai-deploy-22-multi-agent-swarm
```
...
{
  "primitives": {
    "skills": ["skills/fai-deploy-22-multi-agent-swarm/"]
  }
}
```
