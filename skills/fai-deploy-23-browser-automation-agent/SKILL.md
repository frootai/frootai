---
name: fai-deploy-23-browser-automation-agent
description: 'Executes production deployment workflow for Solution Play 23 Browser Automation Agent.'
---

# FAI Skill: Deploy 23 Browser Automation Agent

## Purpose

This skill provides a production-oriented workflow for Browser automation reliability, safety boundaries, and execution auditability. It enforces explicit phase evidence, clear release gates, and repeatable handoff quality.

## Inputs

| Input | Description |
|---|---|
| Core parameters | task_profiles, sandbox_policy, browser_targets, monitoring_hooks |
...
| Artifact | Purpose |
|---|---|
| Primary output | deploy-checklist-23.md, safety audit, execution trace sample |
...
- [ ] Completion criteria met: critical paths automated reliably, sandbox constraints enforced, audit trails complete.
