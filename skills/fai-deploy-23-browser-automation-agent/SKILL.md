...
description: Deploy Browser Automation Agent with Selenium and Playwright.
---
...
npx frootai skill run fai-deploy-23-browser-automation-agent
```
...
{
  "primitives": {
    "skills": ["skills/fai-deploy-23-browser-automation-agent/"]
  }
}
```
