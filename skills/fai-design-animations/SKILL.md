---
name: fai-design-animations
description: 'Designs purposeful interface animations with performance budgets and accessibility safeguards.'
---

# FAI Skill: Design Animations

## Purpose

This skill provides a production-oriented workflow for Motion system design balancing delight, clarity, and runtime efficiency. It enforces explicit phase evidence, clear release gates, and repeatable handoff quality.

## Inputs

| Input | Description |
|---|---|
| Core parameters | animation_inventory, motion_tokens, timing_guidelines, reduced_motion_rules |
...
| Artifact | Purpose |
|---|---|
| Primary output | animation-system-spec.md, motion tokens, perf budget checklist |
...
- [ ] Completion criteria met: animation intent documented, reduced-motion compliance ensured, frame budget respected.
