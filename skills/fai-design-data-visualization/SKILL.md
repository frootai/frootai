---
name: fai-design-data-visualization
description: 'Designs data visualization systems with clarity, accessibility, and performance-aware rendering.'
---

# FAI Skill: Design Data Visualization

## Purpose

This skill defines a production-quality workflow for Chart design standards, interaction semantics, and readability under scale. It ensures consistent outcomes through phase-based execution, measurable quality gates, and reliable handoff artifacts.

## Inputs

| Input | Description |
|---|---|
| Core parameters | data_domains, chart_types, interaction_goals, accessibility_targets |
...
| Artifact | Purpose |
|---|---|
| Primary output | visualization-system-spec.md, chart taxonomy, validation checklist |
...
- [ ] Completion criteria met: readability tests pass, color/contrast compliance met, rendering budget respected.
