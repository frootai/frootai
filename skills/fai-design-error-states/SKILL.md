---
name: fai-design-error-states
description: 'Designs actionable error states that improve recovery, trust, and system transparency.'
---

# FAI Skill: Design Error States

## Purpose

This skill defines a production-quality workflow for Error taxonomy, recovery actions, and user-facing diagnostic quality. It ensures consistent outcomes through phase-based execution, measurable quality gates, and reliable handoff artifacts.

## Inputs

| Input | Description |
|---|---|
| Core parameters | failure_scenarios, severity_levels, copy_guidelines, recovery_paths |
...
| Artifact | Purpose |
|---|---|
| Primary output | error-state-spec.md, copy matrix, recovery decision tree |
...
- [ ] Completion criteria met: critical scenarios covered, recovery actions clear, support escalation path defined.
