---
name: fai-design-forms
description: 'Designs high-completion form experiences with robust validation and accessibility support.'
---

# FAI Skill: Design Forms

## Purpose

This skill defines a production-quality workflow for Form architecture, validation strategy, and completion optimization. It ensures consistent outcomes through phase-based execution, measurable quality gates, and reliable handoff artifacts.

## Inputs

| Input | Description |
|---|---|
| Core parameters | form_flows, field_definitions, validation_rules, submission_constraints |
...
| Artifact | Purpose |
|---|---|
| Primary output | form-design-spec.md, validation map, completion optimization notes |
...
- [ ] Completion criteria met: completion funnel improves, validation clarity passes review, keyboard/screen-reader support verified.
