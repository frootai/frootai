---
name: fai-design-icon-system
description: 'Designs scalable icon systems with semantic consistency and implementation governance.'
---

# FAI Skill: Design Icon System

## Purpose

This skill defines a production-quality workflow for Icon language, sizing tokens, and cross-platform consistency. It ensures consistent outcomes through phase-based execution, measurable quality gates, and reliable handoff artifacts.

## Inputs

| Input | Description |
|---|---|
| Core parameters | icon_inventory, semantic_mapping, token_scale, platform_targets |
...
| Artifact | Purpose |
|---|---|
| Primary output | icon-system-spec.md, icon naming rules, governance checklist |
...
- [ ] Completion criteria met: semantic mapping complete, visual consistency approved, token usage standardized.
