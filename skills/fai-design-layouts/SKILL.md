---
name: fai-design-layouts
description: 'Designs adaptive layout systems with clear hierarchy, spacing rhythm, and predictable behavior.'
---

# FAI Skill: Design Layouts

## Purpose

This skill defines a production-quality workflow for Layout grid strategy, breakpoint behavior, and content hierarchy. It ensures consistent outcomes through phase-based execution, measurable quality gates, and reliable handoff artifacts.

## Inputs

| Input | Description |
|---|---|
| Core parameters | page_types, content_priorities, breakpoint_set, spacing_tokens |
...
| Artifact | Purpose |
|---|---|
| Primary output | layout-system-spec.md, breakpoint matrix, hierarchy guide |
...
- [ ] Completion criteria met: layout adapts across target sizes, hierarchy remains clear, overflow issues resolved.
