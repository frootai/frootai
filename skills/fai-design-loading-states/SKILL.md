---
name: fai-design-loading-states
description: 'Designs loading state patterns that reduce uncertainty and perceived latency.'
---

# FAI Skill: Design Loading States

## Purpose

This skill defines a production-quality workflow for Progress communication, skeleton strategies, and latency-aware interaction. It ensures consistent outcomes through phase-based execution, measurable quality gates, and reliable handoff artifacts.

## Inputs

| Input | Description |
|---|---|
| Core parameters | async_flows, latency_profiles, loading_components, fallback_rules |
...
| Artifact | Purpose |
|---|---|
| Primary output | loading-state-spec.md, skeleton patterns, fallback guidance |
...
- [ ] Completion criteria met: perceived wait time reduced, stalled states handled, accessibility announcements present.
