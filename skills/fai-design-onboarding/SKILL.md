---
name: fai-design-onboarding
description: 'Designs onboarding flows that accelerate activation and reduce user drop-off.'
---

# FAI Skill: Design Onboarding

## Purpose

This skill defines a production-quality workflow for Activation milestones, progressive disclosure, and guidance UX. It ensures consistent outcomes through phase-based execution, measurable quality gates, and reliable handoff artifacts.

## Inputs

| Input | Description |
|---|---|
| Core parameters | user_segments, activation_steps, friction_points, success_events |
...
| Artifact | Purpose |
|---|---|
| Primary output | onboarding-spec.md, milestone map, optimization hypotheses |
...
- [ ] Completion criteria met: activation steps measurable, drop-off points addressed, guidance quality validated.
