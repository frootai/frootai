...
description: 'Defines and governs design system tokens for scalable, consistent multi-platform UI delivery.'
---

# FAI Skill: Design System Tokens

## Purpose

This skill defines a production-grade workflow for Token architecture, naming strategy, and versioned theming governance. It applies full phase execution, explicit quality gates, and clear delivery evidence so outcomes remain repeatable.

## Inputs

| Input | Description |
|---|---|
| Core parameters | token_inventory, platform_targets, naming_conventions, migration_rules |
...
| Artifact | Purpose |
|---|---|
| Primary output | token-system-spec.md, token dictionary, migration checklist |
...
- [ ] Completion criteria met: token conflicts resolved, cross-platform mapping complete, adoption plan approved.
