---
name: fai-design-themes
description: 'Designs robust theming architecture with accessibility, brand consistency, and runtime flexibility.'
---

# FAI Skill: Design Themes

## Purpose

This skill defines a production-grade workflow for Theme layering, mode strategy, and visual consistency controls. It applies full phase execution, explicit quality gates, and clear delivery evidence so outcomes remain repeatable.

## Inputs

| Input | Description |
|---|---|
| Core parameters | brand_primitives, accessibility_targets, mode_variants, runtime_constraints |
...
| Artifact | Purpose |
|---|---|
| Primary output | theme-architecture-spec.md, mode matrix, rollout guide |
...
- [ ] Completion criteria met: theme parity validated, contrast gates pass, runtime switching stable.
