...
description: 'Applies domain-driven design to align bounded contexts, ownership, and integration contracts.'
---

# FAI Skill: Domain Driven Design

## Purpose

This skill defines a production-grade workflow for Domain boundaries, ubiquitous language, and anti-corruption integration. It applies full phase execution, explicit quality gates, and clear delivery evidence so outcomes remain repeatable.

## Inputs

| Input | Description |
|---|---|
| Core parameters | domain_model, team_boundaries, event_flows, integration_constraints |
...
| Artifact | Purpose |
|---|---|
| Primary output | ddd-architecture-spec.md, context map, integration contract list |
...
- [ ] Completion criteria met: context boundaries clear, ownership assigned, integration friction reduced.
