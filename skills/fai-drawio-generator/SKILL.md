---
name: fai-drawio-generator
description: 'Generates architecture-ready Draw.io diagrams with consistent notation and reviewable structure.'
---

# FAI Skill: Drawio Generator

## Purpose

This skill defines a production-grade workflow for Diagram generation standards, naming conventions, and architecture traceability. It applies full phase execution, explicit quality gates, and clear delivery evidence so outcomes remain repeatable.

## Inputs

| Input | Description |
|---|---|
| Core parameters | system_components, interactions, environment_views, notation_rules |
...
| Artifact | Purpose |
|---|---|
| Primary output | drawio-diagram-pack.md, diagram source templates, validation checklist |
...
- [ ] Completion criteria met: diagram completeness verified, naming consistent, reviewers can trace architecture decisions.
