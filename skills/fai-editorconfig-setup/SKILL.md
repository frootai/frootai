---
name: fai-editorconfig-setup
description: 'Establishes editor configuration standards for consistent formatting and cross-team collaboration.'
---

# FAI Skill: Editorconfig Setup

## Purpose

This skill defines a production-grade workflow for Formatting consistency, whitespace rules, and contributor onboarding. It applies full phase execution, explicit quality gates, and clear delivery evidence so outcomes remain repeatable.

## Inputs

| Input | Description |
|---|---|
| Core parameters | language_matrix, formatting_policies, indentation_rules, file_patterns |
...
| Artifact | Purpose |
|---|---|
| Primary output | editorconfig-setup-guide.md, policy map, adoption checklist |
...
- [ ] Completion criteria met: format drift reduced, contributor setup simplified, CI formatting checks stable.
