...
description: 'Implements evaluation-driven development loops so quality metrics steer implementation decisions.'
---

# FAI Skill: Eval Driven Dev

## Purpose

This skill defines a production-grade workflow for Metric-first development with continuous evaluation feedback. It uses full six-phase execution with explicit validation gates so outcomes remain reproducible and auditable.

## Inputs

| Input | Description |
|---|---|
| Core parameters | quality_targets, eval_metrics, baseline_scores, iteration_policy |
...
| Artifact | Purpose |
|---|---|
| Primary output | eval-driven-dev-playbook.md, metric dashboard spec, iteration gates |
...
- [ ] Completion criteria met: metric baselines captured, regression gates enforced, iteration decisions evidence-based.
