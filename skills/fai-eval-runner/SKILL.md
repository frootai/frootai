...
description: 'Runs standardized evaluation pipelines with reproducible scoring and traceable outputs.'
---

# FAI Skill: Eval Runner

## Purpose

This skill defines a production-grade workflow for Evaluation execution orchestration, traceability, and reproducibility. It uses full six-phase execution with explicit validation gates so outcomes remain reproducible and auditable.

## Inputs

| Input | Description |
|---|---|
| Core parameters | eval_suite, dataset_version, scoring_rules, output_schema |
...
| Artifact | Purpose |
|---|---|
| Primary output | eval-run-report.md, score artifacts, run metadata |
...
- [ ] Completion criteria met: runs are reproducible, score schema consistent, drift signals captured.
