---
name: fai-evaluate-01-enterprise-rag
description: 'Evaluates Solution Play 01 Enterprise RAG with groundedness, relevance, and citation quality gates.'
---

# FAI Skill: Evaluate 01 Enterprise Rag

## Purpose

This skill defines a production-grade workflow for RAG quality validation for grounding and retrieval performance. It uses full six-phase execution with explicit validation gates so outcomes remain reproducible and auditable.

## Inputs

| Input | Description |
|---|---|
| Core parameters | query_set, citations, grounding_thresholds, latency_slo |
...
| Artifact | Purpose |
|---|---|
| Primary output | evaluate-01-report.md, quality scorecard, remediation actions |
...
- [ ] Completion criteria met: groundedness threshold met, citation coverage complete, latency SLO respected.
