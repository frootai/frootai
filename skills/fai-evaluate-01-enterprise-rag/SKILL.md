...
description: Evaluate Enterprise RAG recall, precision, and groundedness.
---
...
npx frootai skill run fai-evaluate-01-enterprise-rag
```
...
{
  "primitives": {
    "skills": ["skills/fai-evaluate-01-enterprise-rag/"]
  }
}
```
