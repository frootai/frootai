...
description: Evaluate Landing Zone compliance, security posture, and governance.
---
...
npx frootai skill run fai-evaluate-02-ai-landing-zone
```
...
{
  "primitives": {
    "skills": ["skills/fai-evaluate-02-ai-landing-zone/"]
  }
}
```
