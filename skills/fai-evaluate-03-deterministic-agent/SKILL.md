...
description: Evaluate Deterministic Agent output consistency and reliability.
---
...
npx frootai skill run fai-evaluate-03-deterministic-agent
```
...
{
  "primitives": {
    "skills": ["skills/fai-evaluate-03-deterministic-agent/"]
  }
}
```
