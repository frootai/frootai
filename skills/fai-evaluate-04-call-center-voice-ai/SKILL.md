...
description: Evaluate Voice AI latency, accuracy, and conversation quality.
---
...
npx frootai skill run fai-evaluate-04-call-center-voice-ai
```
...
{
  "primitives": {
    "skills": ["skills/fai-evaluate-04-call-center-voice-ai/"]
  }
}
```
