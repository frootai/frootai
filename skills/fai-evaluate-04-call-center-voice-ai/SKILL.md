---
name: fai-evaluate-04-call-center-voice-ai
description: 'Evaluates Solution Play 04 Call Center Voice AI for latency, call quality, and safety compliance.'
---

# FAI Skill: Evaluate 04 Call Center Voice Ai

## Purpose

This skill defines a production-grade workflow for Voice pipeline quality and operational safety evaluation. It uses full six-phase execution with explicit validation gates so outcomes remain reproducible and auditable.

## Inputs

| Input | Description |
|---|---|
| Core parameters | call_scenarios, latency_targets, quality_metrics, safety_rules |
...
| Artifact | Purpose |
|---|---|
| Primary output | evaluate-04-report.md, call-quality analysis, mitigation plan |
...
- [ ] Completion criteria met: end-to-end latency target met, voice quality acceptable, safety checks pass.
