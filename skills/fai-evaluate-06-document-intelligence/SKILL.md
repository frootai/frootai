...
description: Evaluate OCR accuracy and entity extraction correctness.
---
...
npx frootai skill run fai-evaluate-06-document-intelligence
```
...
{
  "primitives": {
    "skills": ["skills/fai-evaluate-06-document-intelligence/"]
  }
}
```
