---
name: fai-evaluate-06-document-intelligence
description: 'Evaluates Solution Play 06 Document Intelligence for extraction accuracy, throughput, and robustness.'
---

# FAI Skill: Evaluate 06 Document Intelligence

## Purpose

This skill defines a production-grade workflow for OCR and extraction quality under realistic document variance. It uses full six-phase execution with explicit validation gates so outcomes remain reproducible and auditable.

## Inputs

| Input | Description |
|---|---|
| Core parameters | document_corpus, extraction_labels, throughput_targets, error_tolerance |
...
| Artifact | Purpose |
|---|---|
| Primary output | evaluate-06-report.md, extraction metrics, failure taxonomy |
...
- [ ] Completion criteria met: accuracy target achieved, throughput acceptable, major failure classes mitigated.
