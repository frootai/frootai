---
name: fai-evaluate-07-multi-agent-service
description: 'Evaluates Solution Play 07 Multi-Agent Service for orchestration reliability and coordinated task quality.'
---

# FAI Skill: Evaluate 07 Multi Agent Service

## Purpose

This skill defines a production-grade workflow for Multi-agent coordination quality, handoff integrity, and resilience. It uses full six-phase execution with explicit validation gates so outcomes remain reproducible and auditable.

## Inputs

| Input | Description |
|---|---|
| Core parameters | agent_workflows, handoff_rules, timeout_policy, quality_thresholds |
...
| Artifact | Purpose |
|---|---|
| Primary output | evaluate-07-report.md, orchestration scorecard, resilience notes |
...
- [ ] Completion criteria met: handoff success rate high, timeout behavior controlled, coordinated outputs meet quality bar.
