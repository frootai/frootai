---
name: fai-evaluate-08-copilot-studio-bot
description: 'Evaluates Solution Play 08 Copilot Studio Bot for conversation quality, channel stability, and safety compliance.'
---

# FAI Skill: Evaluate 08 Copilot Studio Bot

## Purpose

This skill defines a production-grade workflow for Bot response quality, channel reliability, and policy-safe operation. It enforces full phase coverage, strict quality gates, and reproducible delivery evidence.

## Inputs

| Input | Description |
|---|---|
| Core parameters | conversation_set, channel_matrix, safety_thresholds, escalation_rules |
...
| Artifact | Purpose |
|---|---|
| Primary output | evaluate-08-report.md, channel scorecard, remediation backlog |
...
- [ ] Completion criteria met: response quality gate met, channel health stable, safety policy adherence verified.
