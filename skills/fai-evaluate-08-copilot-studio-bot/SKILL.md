...
description: Evaluate bot conversation quality and user satisfaction.
---
...
npx frootai skill run fai-evaluate-08-copilot-studio-bot
```
...
{
  "primitives": {
    "skills": ["skills/fai-evaluate-08-copilot-studio-bot/"]
  }
}
```
