...
description: Evaluate AI Search Portal search quality and reranking accuracy.
---
...
npx frootai skill run fai-evaluate-09-ai-search-portal
```
...
{
  "primitives": {
    "skills": ["skills/fai-evaluate-09-ai-search-portal/"]
  }
}
```
