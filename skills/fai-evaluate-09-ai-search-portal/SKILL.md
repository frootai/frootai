---
name: fai-evaluate-09-ai-search-portal
description: 'Evaluates Solution Play 09 AI Search Portal for relevance, latency, and retrieval robustness.'
---

# FAI Skill: Evaluate 09 Ai Search Portal

## Purpose

This skill defines a production-grade workflow for Search relevance quality, user-query latency, and retrieval resilience. It enforces full phase coverage, strict quality gates, and reproducible delivery evidence.

## Inputs

| Input | Description |
|---|---|
| Core parameters | query_benchmark, relevance_labels, latency_slo, index_config |
...
| Artifact | Purpose |
|---|---|
| Primary output | evaluate-09-report.md, relevance metrics, tuning recommendations |
...
- [ ] Completion criteria met: relevance threshold achieved, p95 latency within target, retrieval failures bounded.
