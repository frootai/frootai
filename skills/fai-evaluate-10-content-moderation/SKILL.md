---
name: fai-evaluate-10-content-moderation
description: 'Evaluates Solution Play 10 Content Moderation for precision, recall, and escalation reliability.'
---

# FAI Skill: Evaluate 10 Content Moderation

## Purpose

This skill defines a production-grade workflow for Moderation accuracy, policy coverage, and escalation effectiveness. It enforces full phase coverage, strict quality gates, and reproducible delivery evidence.

## Inputs

| Input | Description |
|---|---|
| Core parameters | labeled_content_set, policy_profiles, escalation_matrix, false_positive_budget |
...
| Artifact | Purpose |
|---|---|
| Primary output | evaluate-10-report.md, moderation confusion matrix, escalation audit |
...
- [ ] Completion criteria met: precision/recall targets met, policy coverage complete, escalation SLA validated.
