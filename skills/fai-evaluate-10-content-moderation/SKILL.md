...
description: Evaluate Content Moderation coverage and policy adherence.
---
...
npx frootai skill run fai-evaluate-10-content-moderation
```
...
{
  "primitives": {
    "skills": ["skills/fai-evaluate-10-content-moderation/"]
  }
}
```
