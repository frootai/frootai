...
description: Evaluate Advanced Landing Zone resilience and performance.
---
...
npx frootai skill run fai-evaluate-11-ai-landing-zone-advanced
```
...
{
  "primitives": {
    "skills": ["skills/fai-evaluate-11-ai-landing-zone-advanced/"]
  }
}
```
