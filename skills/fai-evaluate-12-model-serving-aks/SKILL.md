...
description: Evaluate Model Serving latency, throughput, and availability.
---
...
npx frootai skill run fai-evaluate-12-model-serving-aks
```
...
{
  "primitives": {
    "skills": ["skills/fai-evaluate-12-model-serving-aks/"]
  }
}
```
