---
name: fai-evaluate-12-model-serving-aks
description: 'Evaluates Solution Play 12 Model Serving on AKS for inference SLOs, autoscale behavior, and resilience.'
---

# FAI Skill: Evaluate 12 Model Serving Aks

## Purpose

This skill defines a production-grade workflow for AKS model serving throughput, latency, scaling, and fault tolerance. It enforces full phase coverage, strict quality gates, and reproducible delivery evidence.

## Inputs

| Input | Description |
|---|---|
| Core parameters | load_profile, gpu_metrics, autoscale_rules, fault_scenarios |
...
| Artifact | Purpose |
|---|---|
| Primary output | evaluate-12-report.md, serving SLO dashboard, scale behavior notes |
...
- [ ] Completion criteria met: latency and throughput SLOs met, autoscale stable, failure recovery validated.
