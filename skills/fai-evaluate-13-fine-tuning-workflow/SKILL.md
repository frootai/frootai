...
description: Evaluate fine-tuning quality improvements and job success.
---
...
npx frootai skill run fai-evaluate-13-fine-tuning-workflow
```
...
{
  "primitives": {
    "skills": ["skills/fai-evaluate-13-fine-tuning-workflow/"]
  }
}
```
