---
name: fai-evaluate-15-multi-modal-docproc
description: 'Evaluates Solution Play 15 Multi-Modal Document Processing for extraction quality, throughput, and compliance controls.'
---

# FAI Skill: Evaluate 15 Multi Modal Docproc

## Purpose

This skill defines a production-grade workflow for Vision+text document pipeline quality, speed, and governance compliance. It enforces full phase coverage, strict quality gates, and reproducible delivery evidence.

## Inputs

| Input | Description |
|---|---|
| Core parameters | document_set, quality_labels, throughput_target, pii_rules |
...
| Artifact | Purpose |
|---|---|
| Primary output | evaluate-15-report.md, extraction quality summary, compliance findings |
...
- [ ] Completion criteria met: quality and throughput gates met, PII control checks pass, failure modes mitigated.
