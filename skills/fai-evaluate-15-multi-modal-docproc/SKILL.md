...
description: Evaluate multi-modal document processing accuracy.
---
...
npx frootai skill run fai-evaluate-15-multi-modal-docproc
```
...
{
  "primitives": {
    "skills": ["skills/fai-evaluate-15-multi-modal-docproc/"]
  }
}
```
