---
name: fai-evaluate-16-copilot-teams-extension
description: 'Evaluates Solution Play 16 Copilot Teams Extension for tenant readiness, response quality, and reliability.'
---

# FAI Skill: Evaluate 16 Copilot Teams Extension

## Purpose

This skill defines a production-grade workflow for Teams extension tenant compatibility, quality consistency, and operational stability. It enforces full phase coverage, strict quality gates, and reproducible delivery evidence.

## Inputs

| Input | Description |
|---|---|
| Core parameters | tenant_scenarios, response_tests, auth_checks, reliability_metrics |
...
| Artifact | Purpose |
|---|---|
| Primary output | evaluate-16-report.md, tenant compatibility matrix, issue triage list |
...
- [ ] Completion criteria met: tenant validation passes, response quality meets bar, reliability metrics stable.
