...
description: Evaluate extension adoption and user engagement metrics.
---
...
npx frootai skill run fai-evaluate-16-copilot-teams-extension
```
...
{
  "primitives": {
    "skills": ["skills/fai-evaluate-16-copilot-teams-extension/"]
  }
}
```
