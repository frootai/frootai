---
name: fai-evaluate-17-ai-observability
description: 'Evaluates Solution Play 17 AI Observability for telemetry completeness, alert fidelity, and incident diagnostics.'
---

# FAI Skill: Evaluate 17 Ai Observability

## Purpose

This skill defines a production-grade workflow for Observability signal quality and incident detection effectiveness. It enforces full phase coverage, strict quality gates, and reproducible delivery evidence.

## Inputs

| Input | Description |
|---|---|
| Core parameters | trace_samples, metric_catalog, alert_history, incident_playbooks |
...
| Artifact | Purpose |
|---|---|
| Primary output | evaluate-17-report.md, telemetry gap analysis, alert tuning plan |
...
- [ ] Completion criteria met: trace coverage complete, alert precision acceptable, incident diagnostics actionable.
