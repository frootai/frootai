...
description: Evaluate observability coverage and alerting effectiveness.
---
...
npx frootai skill run fai-evaluate-17-ai-observability
```
...
{
  "primitives": {
    "skills": ["skills/fai-evaluate-17-ai-observability/"]
  }
}
```
