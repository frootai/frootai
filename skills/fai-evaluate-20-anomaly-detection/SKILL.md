...
description: Evaluate anomaly detection accuracy and false-positive rates.
---
...
npx frootai skill run fai-evaluate-20-anomaly-detection
```
...
{
  "primitives": {
    "skills": ["skills/fai-evaluate-20-anomaly-detection/"]
  }
}
```
