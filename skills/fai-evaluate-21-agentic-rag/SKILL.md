...
description: Evaluate agentic RAG decision quality and retrieval effectiveness.
---
...
npx frootai skill run fai-evaluate-21-agentic-rag
```
...
{
  "primitives": {
    "skills": ["skills/fai-evaluate-21-agentic-rag/"]
  }
}
```
