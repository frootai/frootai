...
description: Evaluate multi-agent swarm coordination and task completion.
---
...
npx frootai skill run fai-evaluate-22-multi-agent-swarm
```
...
{
  "primitives": {
    "skills": ["skills/fai-evaluate-22-multi-agent-swarm/"]
  }
}
```
