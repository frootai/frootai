...
## Overview
Create an fai-manifest.json with context, primitives, infrastructure, and guardrails. This skill provides a production-grade, step-by-step procedure for implementing this capability in FAI solution plays.
