...
description: "Generate a TypeScript MCP server project with esbuild bundling, ESLint config, and test harness using Vitest."
...
| operational-excellence | Ensures compliance with best practices and standards |
| security | Implements necessary security measures and validations |
```bash
