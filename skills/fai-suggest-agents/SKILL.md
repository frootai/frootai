...
description: 'Discovers and recommends relevant FAI agents based on user task description.'
---

# Fai Suggest Agents

Discovers and recommends relevant FAI agents based on user task description.

## Overview

This skill provides a structured, repeatable procedure for discovers and recommends relevant FAI agents based on user task description.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: discovers and recommends relevant FAI agents based on user task description..
...
npx frootai skill run fai-suggest-agents
```
...
{
  "primitives": {
    "skills": ["skills/fai-suggest-agents/"]
  }
}
```
