...
```csharp
[McpServerTool, Description("Search FrootAI solution plays by keyword")]
...
```json
{
  "McpServer": { "Name": "my-frootai-mcp", "Version": "1.0.0", "Transport": "stdio" },
  "AzureOpenAI": { "Endpoint": "https://my-oai.openai.azure.com/", "DeploymentName": "gpt-4o" },
  "Search": { "Endpoint": "https://my-search.search.windows.net", "IndexName": "frootai-knowledge" }
}
```
