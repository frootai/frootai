...
## Overview
Create a GitHub Actions CI/CD pipeline with evaluation gates for AI apps. This skill provides a production-grade, step-by-step procedure for implementing this capability in FAI solution plays.
