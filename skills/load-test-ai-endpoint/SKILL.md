...
## Overview
Load test an AI endpoint with k6/Locust for p95 latency and error rates. This skill provides a production-grade, step-by-step procedure for implementing this capability in FAI solution plays.
