...
## Overview
Set up Managed Identity with RBAC role assignments for Azure services. This skill provides a production-grade, step-by-step procedure for implementing this capability in FAI solution plays.
