...
## Overview
Implement model routing logic: cheap model for simple, capable for complex tasks. This skill provides a production-grade, step-by-step procedure for implementing this capability in FAI solution plays.
