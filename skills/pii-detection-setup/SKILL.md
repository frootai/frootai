...
## Overview
Set up PII detection and masking with Azure AI Language service. This skill provides a production-grade, step-by-step procedure for implementing this capability in FAI solution plays.
