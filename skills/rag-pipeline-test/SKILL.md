...
## Overview
Test a RAG pipeline end-to-end with relevance and groundedness metrics. This skill provides a production-grade, step-by-step procedure for implementing this capability in FAI solution plays.
