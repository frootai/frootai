...
## Overview
Set up RBAC role assignments for a solution play's Azure resources. This skill provides a production-grade, step-by-step procedure for implementing this capability in FAI solution plays.
