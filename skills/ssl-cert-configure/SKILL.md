...
## Overview
Configure SSL certificates for custom domains on Azure App Service/AKS. This skill provides a production-grade, step-by-step procedure for implementing this capability in FAI solution plays.
