...
## Overview
Set up webhooks for AI system events: evaluation results, safety alerts, cost alerts. This skill provides a production-grade, step-by-step procedure for implementing this capability in FAI solution plays.
