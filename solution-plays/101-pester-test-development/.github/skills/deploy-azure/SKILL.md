---
name: "deploy-azure"
description: "Deploy Pester Test Development (Play 101) infrastructure and application to Azure"
---

# Deploy Azure — Pester Test Development

## Overview
This skill deploys the Pester Test Development solution play to Azure using Bicep infrastructure-as-code and Azure Developer CLI.
