#!/bin/bash
# Deploy Pester Test Development to Azure
# Usage: ./deploy.sh [dev|staging|prod]

set -euo pipefail

ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-pester-test-development-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="101-pester-test-development"

echo "═══ Deploying Pester Test Development ═══"
...
echo "═══ Pester Test Development deployed successfully ═══"
