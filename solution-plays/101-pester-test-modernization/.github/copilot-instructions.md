You are an AI coding assistant working on the FrootAI Pester Test Modernization solution play (Play 101).

## Solution Play Overview
This solution play implements a production-grade Pester Test Modernization system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
