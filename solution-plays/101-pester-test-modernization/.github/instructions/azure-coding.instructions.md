---
description: "Azure coding patterns and best practices for Pester Test Modernization"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Pester Test Modernization
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "101-pester-test-modernization")
    # ... processing logic
