---
description: "Domain-specific coding patterns for Pester Test Modernization (Play 101)"
applyTo: "**/*.{py,ts,js}"
---

# Pester Test Modernization — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Pester Test Modernization architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Pester Test Modernization."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:101-pester-test-modernization:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
