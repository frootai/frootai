...
> **FrootAI Solution Play** — Production-grade Foundry Local On Device on Azure with FAI Protocol integration
...
## Overview
This solution play implements a production-ready Foundry Local On Device system using Azure AI Services, following the FrootAI FAI Protocol for AI primitive unification and the Azure Well-Architected Framework (WAF) across all six pillars.
...
cd solution-plays/44-foundry-local-on-device
```
