...
> **FrootAI Solution Play** — Production-grade Supply Chain Ai on Azure with FAI Protocol integration
...
## Overview
This solution play implements a production-ready Supply Chain Ai system using Azure AI Services, following the FrootAI FAI Protocol for AI primitive unification and the Azure Well-Architected Framework (WAF) across all six pillars.
...
cd solution-plays/55-supply-chain-ai
```
