...
> **FrootAI Solution Play** — Production-grade Semantic Code Search on Azure with FAI Protocol integration
...
## Overview
This solution play implements a production-ready Semantic Code Search system using Azure AI Services, following the FrootAI FAI Protocol for AI primitive unification and the Azure Well-Architected Framework (WAF) across all six pillars.
...
cd solution-plays/56-semantic-code-search
```
