...
| **Distractor Quality** | Wrong options aren't wrong | > 80% |
| **Explanation Quality** | Feedback explains correct answer | > 4.0/5.0 |
| **Passing Score Calibration** | Passers demonstrate mastery | > 85% correlation |
...
| **Time to Competency** | matches estimate | Within 25% |
