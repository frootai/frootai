...
const MCP_TOOLS: McpTool[] = [
  ...
  { name: "list_community_plays", description: "List all solution plays", category: "Plays", readOnly: true },
  ...
  { name: "list_primitives", description: "Browse FrootAI AI primitives", category: "Primitives", readOnly: true },
