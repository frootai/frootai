...
const DEFAULT_TOOLS: McpTool[] = [
  ...
  { name: "lookup_term", description: "AI and machine-learning glossary lookup", category: "Knowledge", readOnly: true },
  ...
  { name: "list_marketplace", description: "Browse the active FAI primitive catalog by type", category: "Primitives", readOnly: true },
