...
function getFollowUps(lastReply: string): string[] {
  ...
  if (r.includes("mcp") || r.includes("npx frootai")) return ["List all 23 MCP tools", "How do agent chain tools work?", "What's the model catalog tool?"];
...
export default function ChatbotPage(): JSX.Element {
  ...
  return (
    <Layout title="Agent FAI - FrootAI" description="AI-powered architecture guide. Grounded in 20 solution plays, 23 MCP tools, 16 knowledge modules.">
