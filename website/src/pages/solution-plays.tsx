...
const plays = [
  ...
  { id: "04", name: "Call Center Voice AI", icon: "📞", status: "Ready", cx: "High", desc: "Voice-enabled customer service — Communication Services + AI Speech + OpenAI Agent.", infra: "Communication Services · AI Speech · Azure OpenAI · Container Apps", tune: "Speech config · grounding prompts · fallback chains · voice personality", github: "https://github.com/gitpavleenbali/frootai/tree/main/solution-plays/04-call-center-voice-ai",
    userGuide: "/user-guide?play=04",
    devkitFiles: ["agent.md", "instructions.md", "copilot-instructions.md", ".vscode/mcp.json", "mcp/index.js", "plugins/"],
    tunekitFiles: ["config/openai.json", "config/guardrails.json", "infra/main.bicep", "evaluation/"],
    guide: "Production configs ready. DevKit + TuneKit + SpecKit + guardrails present. Open in VS Code  Copilot reads agent.md and builds from configs." },
  { id: "05", name: "IT Ticket Resolution", icon: "🎫", status: "Ready", cx: "Medium", desc: "Auto-classify, route, and resolve IT tickets — Logic Apps + AI Foundry + ServiceNow MCP.", infra: "Logic Apps · Azure OpenAI · ServiceNow MCP · Container Apps", tune: "Classification prompts · routing rules · confidence thresholds", github: "https://github.com/gitpavleenbali/frootai/tree/main/solution-plays/05-it-ticket-resolution",
    userGuide: "/user-guide?play=05",
    userGuide: "/user-guide?play=05",
    devkitFiles: ["agent.md", "instructions.md", "copilot-instructions.md", ".vscode/mcp.json", "mcp/index.js", "plugins/"],
    tunekitFiles: ["config/openai.json", "config/guardrails.json", "infra/main.bicep", "evaluation/"],
    guide: "Production configs ready. DevKit + TuneKit + SpecKit + guardrails present. Open in VS Code  Copilot reads agent.md and builds from configs." },
  { id: "06", name: "Document Intelligence", icon: "📄", status: "Ready", cx: "Medium", desc: "Extract, classify, and structure document data — Blob + Doc Intelligence + OpenAI.", infra: "Blob Storage · Document Intelligence · Azure OpenAI · Cosmos DB", tune: "Extraction prompts · confidence thresholds · field schemas", github: "https://github.com/gitpavleenbali/frootai/tree/main/solution-plays/06-document-intelligence",
    userGuide: "/user-guide?play=06",
    devkitFiles: ["agent.md", "instructions.md", "copilot-instructions.md", ".vscode/mcp.json", "mcp/index.js", "plugins/"],
    tunekitFiles: ["config/openai.json", "config/guardrails.json", "infra/main.bicep", "evaluation/"],
    guide: "Production configs ready. DevKit + TuneKit + guardrails present." },
  { id: "07", name: "Multi-Agent Service", icon: "🤖", status: "Ready", cx: "High", desc: "Supervisor agent routes to specialists — Container Apps + Agent Framework + Dapr.", infra: "Container Apps · Azure OpenAI · Cosmos DB · Dapr", tune: "Supervisor routing · tool schemas · agent memory · handoff rules", github: "https://github.com/gitpavleenbali/frootai/tree/main/solution-plays/07-multi-agent-service",
    userGuide: "/user-guide?play=07",
    devkitFiles: ["agent.md", "instructions.md", "copilot-instructions.md", ".vscode/mcp.json", "mcp/index.js", "plugins/"],
    tunekitFiles: ["config/openai.json", "config/guardrails.json", "infra/main.bicep", "evaluation/"],
    guide: "Production configs ready. DevKit + TuneKit files present." },
  { id: "08", name: "Copilot Studio Bot", icon: "💬", status: "Ready", cx: "Low", desc: "Low-code enterprise bot — Copilot Studio + Dataverse + SharePoint.", infra: "Copilot Studio · Dataverse · SharePoint · Power Platform", tune: "Topic design · knowledge sources · guardrails · flow", github: "https://github.com/gitpavleenbali/frootai/tree/main/solution-plays/08-copilot-studio-bot",
    userGuide: "/user-guide?play=08",
    devkitFiles: ["agent.md", "instructions.md", "copilot-instructions.md", ".vscode/mcp.json", "mcp/index.js", "plugins/"],
    tunekitFiles: ["config/openai.json", "config/guardrails.json", "infra/main.bicep", "evaluation/"],
    guide: "Production configs ready. DevKit + TuneKit files present." },
  { id: "09", name: "AI Search Portal", icon: "🔎", status: "Ready", cx: "Medium", desc: "Enterprise search — AI Search + Web App + Semantic Ranking.", infra: "AI Search · App Service · Azure OpenAI · Blob Storage", tune: "Hybrid weights · semantic config · scoring profiles · filters", github: "https://github.com/gitpavleenbali/frootai/tree/main/solution-plays/09-ai-search-portal",
    userGuide: "/user-guide?play=09",
    devkitFiles: ["agent.md", "instructions.md", "copilot-instructions.md", ".vscode/mcp.json", "mcp/index.js", "plugins/"],
    tunekitFiles: ["config/openai.json", "config/guardrails.json", "infra/main.bicep", "evaluation/"],
    guide: "Production configs ready. DevKit + TuneKit files present." },
  { id: "10", name: "Content Moderation", icon: "🛡️", status: "Ready", cx: "Low", desc: "Filter harmful content — AI Content Safety + APIM + Functions.", infra: "Content Safety · API Management · Azure Functions", tune: "Severity levels · custom categories · blocklists · actions", github: "https://github.com/gitpavleenbali/frootai/tree/main/solution-plays/10-content-moderation",
    userGuide: "/user-guide?play=10",
    devkitFiles: ["agent.md", "instructions.md", "copilot-instructions.md", ".vscode/mcp.json", "mcp/index.js", "plugins/"],
    tunekitFiles: ["config/openai.json", "config/guardrails.json", "infra/main.bicep", "evaluation/"],
    guide: "Production configs ready. DevKit + TuneKit files present." },
  { id: "11", name: "Landing Zone Advanced", icon: "🏔️", status: "Ready", cx: "High", desc: "Multi-region, policy-driven, enterprise-grade AI landing zone with governance at scale.", infra: "Multi-region VNet · Azure Policy · PE · RBAC · GPU Quota", tune: "Governance policies · multi-region config · advanced RBAC", github: "https://github.com/gitpavleenbali/frootai/tree/main/solution-plays/11-ai-landing-zone-advanced",
    userGuide: "/user-guide?play=11",
    devkitFiles: ["agent.md", "instructions.md", "copilot-instructions.md", ".vscode/mcp.json", "mcp/index.js", "plugins/"],
    tunekitFiles: ["config/openai.json", "config/guardrails.json", "infra/main.bicep", "evaluation/"],
    guide: "Production configs ready. DevKit + TuneKit files present. Advanced landing zone with multi-region + policy." },
  { id: "12", name: "Model Serving AKS", icon: "⚙️", status: "Ready", cx: "High", desc: "Deploy and serve LLMs on AKS with vLLM, GPU nodes, and auto-scaling.", infra: "AKS · vLLM · NVIDIA GPU · Container Registry", tune: "Quantization · batching · scaling rules · model config", github: "https://github.com/gitpavleenbali/frootai/tree/main/solution-plays/12-model-serving-aks",
    userGuide: "/user-guide?play=12",
    devkitFiles: ["agent.md", "instructions.md", "copilot-instructions.md", ".vscode/mcp.json", "mcp/index.js", "plugins/"],
    tunekitFiles: ["config/openai.json", "config/guardrails.json", "infra/main.bicep", "evaluation/"],
    guide: "Production configs ready. DevKit + TuneKit files present. AKS + vLLM + GPU model serving." },
  { id: "13", name: "Fine-Tuning Workflow", icon: "🔬", status: "Ready", cx: "High", desc: "End-to-end fine-tuning — data prep, LoRA training, evaluation, deployment.", infra: "AI Foundry · GPU Compute · Storage · MLflow", tune: "LoRA rank · learning rate · epochs · eval metrics", github: "https://github.com/gitpavleenbali/frootai/tree/main/solution-plays/13-fine-tuning-workflow",
    userGuide: "/user-guide?play=13",
    devkitFiles: ["agent.md", "instructions.md", "copilot-instructions.md", ".vscode/mcp.json", "mcp/index.js", "plugins/"],
    tunekitFiles: ["config/openai.json", "config/guardrails.json", "infra/main.bicep", "evaluation/"],
    guide: "Production configs ready. DevKit + TuneKit files present. LoRA fine-tuning pipeline." },
  { id: "14", name: "AI Gateway", icon: "🚪", status: "Ready", cx: "Medium", desc: "APIM-based AI gateway with semantic caching, load balancing, and token budgets.", infra: "API Management · Redis Cache · Azure OpenAI (multi-region)", tune: "Token budgets · caching rules · fallback chain · rate limits", github: "https://github.com/gitpavleenbali/frootai/tree/main/solution-plays/14-cost-optimized-ai-gateway",
    userGuide: "/user-guide?play=14",
    devkitFiles: ["agent.md", "instructions.md", "copilot-instructions.md", ".vscode/mcp.json", "mcp/index.js", "plugins/"],
    tunekitFiles: ["config/openai.json", "config/guardrails.json", "infra/main.bicep", "evaluation/"],
    guide: "Production configs ready. DevKit + TuneKit files present. APIM AI gateway with caching." },
  { id: "15", name: "Multi-Modal DocProc", icon: "🖼️", status: "Ready", cx: "Medium", desc: "Process documents with text + images using GPT-4o multi-modal capabilities.", infra: "GPT-4o · Blob Storage · Cosmos DB · Functions", tune: "Image prompts · extraction schemas · confidence thresholds", github: "https://github.com/gitpavleenbali/frootai/tree/main/solution-plays/15-multi-modal-docproc",
    userGuide: "/user-guide?play=15",
    devkitFiles: ["agent.md", "instructions.md", "copilot-instructions.md", ".vscode/mcp.json", "mcp/index.js", "plugins/"],
    tunekitFiles: ["config/openai.json", "config/guardrails.json", "infra/main.bicep", "evaluation/"],
    guide: "Production configs ready. DevKit + TuneKit files present." },
  { id: "16", name: "Copilot Teams Extension", icon: "👥", status: "Ready", cx: "Medium", desc: "M365 Copilot extension with Graph API and declarative agents.", infra: "M365 Copilot · Graph API · Azure Functions · App Reg", tune: "Declarative agent config · permissions · scoping", github: "https://github.com/gitpavleenbali/frootai/tree/main/solution-plays/16-copilot-teams-extension",
    userGuide: "/user-guide?play=16",
    devkitFiles: ["agent.md", "instructions.md", "copilot-instructions.md", ".vscode/mcp.json", "mcp/index.js", "plugins/"],
    tunekitFiles: ["config/openai.json", "config/guardrails.json", "infra/main.bicep", "evaluation/"],
    guide: "Production configs ready. DevKit + TuneKit files present." },
  { id: "17", name: "AI Observability", icon: "📊", status: "Ready", cx: "Medium", desc: "Monitor AI workloads with KQL queries, quality alerts, and workbooks.", infra: "App Insights · Log Analytics · Azure Monitor · Workbooks", tune: "KQL queries · alert thresholds · quality metrics", github: "https://github.com/gitpavleenbali/frootai/tree/main/solution-plays/17-ai-observability",
    userGuide: "/user-guide?play=17",
    devkitFiles: ["agent.md", "instructions.md", "copilot-instructions.md", ".vscode/mcp.json", "mcp/index.js", "plugins/"],
    tunekitFiles: ["config/openai.json", "config/guardrails.json", "infra/main.bicep", "evaluation/"],
    guide: "Production configs ready. DevKit + TuneKit files present." },
  { id: "18", name: "Prompt Management", icon: "📝", status: "Ready", cx: "Medium", desc: "Version control, A/B test, and rollback prompts across environments.", infra: "Prompt Flow · Git · GitHub Actions · AI Foundry", tune: "Prompt versions · A/B weights · rollback rules", github: "https://github.com/gitpavleenbali/frootai/tree/main/solution-plays/18-prompt-management",
    userGuide: "/user-guide?play=18",
    devkitFiles: ["agent.md", "instructions.md", "copilot-instructions.md", ".vscode/mcp.json", "mcp/index.js", "plugins/"],
    tunekitFiles: ["config/openai.json", "config/guardrails.json", "infra/main.bicep", "evaluation/"],
    guide: "Production configs ready. DevKit + TuneKit files present." },
  { id: "19", name: "Edge AI Phi-4", icon: "📱", status: "Ready", cx: "High", desc: "Deploy Phi-4 on edge devices with ONNX quantization and local serving.", infra: "IoT Hub · Container Instances · ONNX Runtime · Edge", tune: "Quantization level · model config · sync schedule", github: "https://github.com/gitpavleenbali/frootai/tree/main/solution-plays/19-edge-ai-phi4",
    userGuide: "/user-guide?play=19",
    devkitFiles: ["agent.md", "instructions.md", "copilot-instructions.md", ".vscode/mcp.json", "mcp/index.js", "plugins/"],
    tunekitFiles: ["config/openai.json", "config/guardrails.json", "infra/main.bicep", "evaluation/"],
    guide: "Production configs ready. DevKit + TuneKit files present." },
  { id: "20", name: "Anomaly Detection", icon: "🚨", status: "Ready", cx: "High", desc: "Detect anomalies in real-time streams — Event Hub + AI analysis.", infra: "Event Hub · Stream Analytics · Azure OpenAI · Functions", tune: "Threshold config · alert prompts · detection windows", github: "https://github.com/gitpavleenbali/frootai/tree/main/solution-plays/20-anomaly-detection",
