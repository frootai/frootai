      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: "12px", marginBottom: "32px" }}>
          {[
            ...
            { icon: "🔌", title: "MCP Tools", desc: "See all 23 MCP tools at a glance. Know what your agent can do." },
          ].map((f) => (
        ...
        <div style={{ marginBottom: "32px" }}>
          {[
            ...
            { cmd: "FrootAI: Start MCP Server", desc: "Launch frootai-mcp in terminal (23 tools: 6 static + 4 live + 6 new)", hot: true },
