...
Consecutive active months per contributor.
...
- `gh` unavailable: skip PR/issue queries; note in report
- Date calc differences (macOS vs Linux): use Node.js fallback
- Special chars in names: sanitize for markdown tables
